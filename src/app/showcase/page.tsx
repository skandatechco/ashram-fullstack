...
export default function ShowcasePage() {
  // Map to the shape EventCalendar expects: { attributes: { start_date, end_date, ... } }
  const calendarEvents = sampleEvents.map((e) => ({
    attributes: {
      id: e.id,
      title: e.title,
      description: e.description,
      start_date: e.start, // <- snake_case expected by EventCalendar
      end_date: e.end,     // <- snake_case expected by EventCalendar
      location: e.location,
      tags: e.tags ?? [],
    ...
    <main className="min-h-screen bg-white">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-6">
              ...
              <div className="border rounded-2xl p-4 bg-gray-50">
                {/* BookingWidget requires eventType */}
      ...
      <section className="bg-gray-50 border-t">
        <div className="mx-auto max-w-7xl px-6 py-12">
          ...
          {/* EventCalendar expects events as [{ attributes: { start_date, end_date, ... } }] */}
